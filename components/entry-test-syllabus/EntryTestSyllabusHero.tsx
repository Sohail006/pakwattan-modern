          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 text-sm font-semibold">
                ...
                <span>Test Preparation Resources</span>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                ...
                variant="accent" 
                size="lg"
                className="group bg-white text-primary-600 hover:bg-white/90 font-bold"
              >
              ...
              <Button 
                ...
                variant="outline"
                size="lg"
                className="group bg-white/10 backdrop-blur-sm border-2 border-white/30 text-white hover:bg-white/20 font-semibold"
              >
