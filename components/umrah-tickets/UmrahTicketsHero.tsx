        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-lg text-white/80 leading-relaxed">
                We recognize and reward our outstanding students who have achieved top positions 
                in SSC and HSSC board examinations with Umrah tickets as a token of appreciation.
              </p>
            </div>
          ...
          <div className="relative">
            <div className="aspect-video rounded-2xl overflow-hidden shadow-2xl">
              <Image
                src="/images/achievements/UmrahTickets/1.jpg"
                alt="Umrah Tickets Recognition"
                fill
