...
const UmrahTicketsDetails = () => {
  const criteria = [
    {
      title: "SSC Top Position",
      description: "Students securing 1st position in SSC board examinations",
      icon: "🥇"
    },
    {
      title: "HSSC Top Position",
      description: "Students securing 1st position in HSSC board examinations",
      icon: "🏆"
    },
    {
    ...
    },
    {
      ...
      description: "Maintaining high grades throughout academic year",
      icon: "📈"
    },
    {
      title: "Leadership Qualities",
      description: "Demonstrating leadership in school activities",
      icon: "👑"
    },
    {
      title: "Character Excellence",
      description: "Exemplary character and moral values",
      icon: "⭐"
    }
  ]
      ...
      <div className="container-custom">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Our students are recognized for their exceptional academic achievements and character
          </p>
        </div>
...
export default UmrahTicketsDetails
