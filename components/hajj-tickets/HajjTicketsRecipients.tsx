...
const HajjTicketsRecipients = () => {
  ...
  return (
    <section id="hajj-recipients" className="scroll-mt-20 py-16 bg-gradient-to-br from-primary-50 to-accent-50">
...
export default HajjTicketsRecipients
