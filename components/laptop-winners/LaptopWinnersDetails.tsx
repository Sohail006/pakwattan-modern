...
const LaptopWinnersDetails = () => {
  const criteria = [
    ...
    },
    {
      ...
      description: "Students from economically disadvantaged backgrounds",
      icon: "💝"
    },
    {
      ...
      <div className="container-custom">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Our laptop recipients are selected based on comprehensive evaluation criteria
          </p>
        </div>
...
export default LaptopWinnersDetails
