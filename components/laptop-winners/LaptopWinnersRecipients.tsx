...
const LaptopWinnersRecipients = () => {
  ...
  return (
    <section id="laptop-recipients" className="scroll-mt-20 py-16 bg-gradient-to-br from-primary-50 to-accent-50">
      <div className="container-custom">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Recognizing and empowering our deserving students with laptops for their academic journey
          </p>
        </div>
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <div className="flex items-center space-x-2 bg-accent-100 rounded-full px-4 py-2">
                            <span>💻</span>
                            <span className="text-accent-700 font-semibold">Laptop Award</span>
                          </div>
                        </div>
                      </div>
...
export default LaptopWinnersRecipients
