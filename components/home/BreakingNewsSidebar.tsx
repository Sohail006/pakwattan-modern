        ...
        <div className="flex h-full flex-col">
          <div className="flex h-full flex-col p-2.5 sm:p-3">
            ...
            <div className="mt-auto shrink-0 space-y-1.5 border-t border-gray-100 pt-2">
              ...
              <Link
                href="/contact"
                className="flex w-full items-center justify-center rounded-md border border-secondary-100 bg-secondary-50 px-2 py-1.5 text-center text-[11px] font-semibold text-secondary-800 hover:bg-secondary-100"
              >
                Contact
              </Link>
              <a
