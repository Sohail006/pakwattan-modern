...
import { ChevronLeft, ChevronRight, Award, ZoomIn, Users } from 'lucide-react'
...
const HajjTickets = () => {
  ...
  return (
    <>
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-blue-50 via-primary-50 to-accent-50 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="text-center mb-10 sm:mb-12 lg:mb-16">
            <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full px-6 sm:px-8 py-2 sm:py-3 mb-6 shadow-lg">
              <span className="text-2xl">🕋</span>
              <span className="text-sm sm:text-base md:text-lg font-bold text-white">Hajj Recognition</span>
            </div>
          ...
          <div className="relative max-w-7xl mx-auto">
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden border-4 border-blue-300/30">
              <div className="relative min-h-[600px] sm:min-h-[700px] overflow-hidden bg-gradient-to-br from-blue-50/50 to-primary-50/50">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent flex items-end p-6 sm:p-8">
                              <div className="text-white w-full">
                                <div className="flex items-center space-x-2 mb-2">
                                  ...
                                  <span className="text-sm font-medium text-blue-300">{recipient.position}</span>
                                </div>
                        ...
                        <div className="order-1 lg:order-2 flex flex-col justify-center space-y-6">
                          <div className="bg-white/95 backdrop-blur-sm rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl">
                            <div className="space-y-6">
                              <div className="p-4 bg-gradient-to-r from-blue-100 to-primary-100 rounded-lg border-l-4 border-blue-500">
                                <div className="flex items-center space-x-2 mb-2">
                              ...
                              <div className="flex flex-col sm:flex-row gap-3">
                                <div className="flex items-center space-x-2 bg-blue-100 rounded-full px-4 py-2 flex-1 justify-center">
                                  <Users className="w-5 h-5 text-blue-600" />
                                  <span className="text-sm font-semibold text-blue-700">Staff Recognition</span>
                                </div>
                                <div className="flex items-center space-x-2 bg-accent-100 rounded-full px-4 py-2 flex-1 justify-center">
                                  <span className="text-xl">🕋</span>
                                  <span className="text-sm font-semibold text-accent-700">Hajj Recognition</span>
                                </div>
                              </div>
                            </div>
                          </div>
              ...
              <button
                onClick={prevSlide}
                className="absolute left-4 sm:left-6 top-1/2 -translate-y-1/2 w-12 h-12 sm:w-14 sm:h-14 bg-white hover:bg-blue-50 active:bg-blue-100 text-secondary-700 hover:text-blue-600 rounded-full flex items-center justify-center shadow-xl hover:shadow-2xl transition-all duration-300 z-20 hover:scale-110 active:scale-95 touch-target min-h-[44px] min-w-[44px] border-2 border-blue-200"
              ...
              <button
                onClick={nextSlide}
                className="absolute right-4 sm:right-6 top-1/2 -translate-y-1/2 w-12 h-12 sm:w-14 sm:h-14 bg-white hover:bg-blue-50 active:bg-blue-100 text-secondary-700 hover:text-blue-600 rounded-full flex items-center justify-center shadow-xl hover:shadow-2xl transition-all duration-300 z-20 hover:scale-110 active:scale-95 touch-target min-h-[44px] min-w-[44px] border-2 border-blue-200"
              ...
              <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg z-20">
                <span className="text-sm font-semibold text-secondary-700">
                  {currentSlide + 1} / {hajjRecipients.length}
                </span>
              </div>
            </div>
          </div>
