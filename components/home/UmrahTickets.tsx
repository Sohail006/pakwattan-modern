                      ...
                      <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center space-x-3">
                            <span>🏆</span>
                            <span className="text-gray-700 font-medium">Position: {recipient.position}</span>
                          </div>
                          <div className="flex items-center space-x-3">
                            <span>🕋</span>
                        ...
                        <div className="flex items-center space-x-4">
                          <div className="flex items-center space-x-2 bg-accent-100 rounded-full px-4 py-2">
                            <span>🌟</span>
                            <span className="text-accent-700 font-semibold">Academic Excellence</span>
                          </div>
                          <div className="flex items-center space-x-2 bg-primary-100 rounded-full px-4 py-2">
                            <span>🕋</span>
                            <span className="text-primary-700 font-semibold">Umrah Recognition</span>
                          </div>
                        </div>
                      </div>
