                      ...
                      <div className="space-y-4 sm:space-y-6">
                        ...
                        <div className="space-y-3 sm:space-y-4">
                          <div className="flex items-center space-x-2 sm:space-x-3">
                            ...
                            <span className="text-sm sm:text-base text-gray-700 font-medium break-words">Laptop Recipient</span>
                          </div>
                          <div className="flex items-center space-x-2 sm:space-x-3">
                            <span className="flex-shrink-0">🏆</span>
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4">
                          <div className="flex items-center space-x-2 bg-accent-100 rounded-full px-3 sm:px-4 py-1.5 sm:py-2">
                            <span>💻</span>
                            <span className="text-xs sm:text-sm text-accent-700 font-semibold break-words">Technology Support</span>
                          </div>
                          <div className="flex items-center space-x-2 bg-primary-100 rounded-full px-3 sm:px-4 py-1.5 sm:py-2">
                            <span>🎓</span>
                            <span className="text-xs sm:text-sm text-primary-700 font-semibold break-words">Educational Excellence</span>
                          </div>
                        </div>
                      </div>
