...
import { Coins, Users, Megaphone } from 'lucide-react'
      ...
      <Container>
        ...
        <Card className="p-4 sm:p-6 lg:p-8 mt-6 sm:mt-8 lg:mt-12 bg-gradient-to-r from-yellow-50 to-orange-50 border-l-4 border-yellow-400">
          <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 flex items-center">
            <Megaphone className="w-5 h-5 sm:w-6 sm:h-6 text-primary-600 mr-2 sm:mr-3 flex-shrink-0" />
          ...
          <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-700 mb-4 sm:mb-5">
