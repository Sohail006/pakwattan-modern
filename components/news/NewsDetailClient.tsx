      ...
      <div className="min-h-screen bg-gradient-to-br from-primary-50 to-accent-50 flex items-center justify-center">
        <Container>
          <div className="text-center">
            <Loader2 className="w-8 h-8 animate-spin text-primary-600 mx-auto mb-4" aria-hidden />
        ...
        <Container>
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">
              {error || "The news item you're looking for doesn't exist."}
            </p>
            <Link
              href="/news"
      ...
      <Container>
        <div className="py-8 md:py-12">
          ...
          <article className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="bg-gradient-to-r from-primary-500 to-accent-500 p-6 md:p-8">
              ...
              <div className="flex items-center text-white/90">
                <Calendar className="w-5 h-5 mr-2" aria-hidden />
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <div className="bg-primary-50 rounded-lg p-6 my-8 border-l-4 border-primary-500">
                  ...
                  <div className="space-y-2 text-gray-700">
                    <p>
                      <strong>Date:</strong> {formatDate(newsItem.date)}
                    </p>
                    {newsItem.category && (
                      <p>
          ...
          {relatedNews.length > 0 && (
            <div className="mt-12">
              <h2 className="text-2xl md:text-3xl font-bold text-secondary-800 mb-6">Related News</h2>
