...
import { BookOpen, GraduationCap, Award, TrendingUp, Calendar } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">Welcome back! View your academic progress and assignments.</p>
      </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-700 group-hover:text-primary-700">My Courses</span>
            </Link>
            <Link
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-700 group-hover:text-primary-700">My Grades</span>
            </Link>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-gray-900">Welcome to Student Dashboard</p>
                <p className="text-xs text-gray-500 mt-1">View your academic records and progress here</p>
              </div>
            </div>
          </div>
        </div>
